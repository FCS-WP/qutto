...
class ProductCategories extends AbstractDynamicBlock
{
    ...
    protected function renderListItems($categories, $attributes, $uid, $depth = 0)
    {
        ...
        if (!empty($categories)) {
            ...
            $output .= "<li class='wc-block-product-categories-list-item'>
                <a href='/shop'>
                    <span class='wc-block-product-categories-list-item__name'>All</span>
                    <span class='wc-block-product-categories-list-item-count'>$count->publish</span>
                </span>
                </a>
            </li>";
            foreach ($categories as $category) {
